...
export function initializeLibrary() {
    ...
    books.push(
        new DigitalBook("9780134685991", "PARALLEL WORLDS", "Michio Kaku", 2012, 2, "fiction", "24 MB", "PDF",
            "covers/pworlds.png", "books/pworlds.pdf"),
        new DigitalBook("978013", "THE DON", "Ronald Perry", 2012, 2, "non-fiction", "84 MB", "PDF",
            "covers/don.png", "books/TheDon(Roland Perry).pdf"),
        new Book("9781491950296", "BEING LOGICAL", "D.Q McInery", 2020, 10, "non-fiction",
            "covers/logi.png", "books/being.pdf"),
        new Book("91950296", "UNTIL THE END OF TIME", "Brian Green", 2017, 6, "fiction",
            "covers/green.png", "books/green.epub"),
        new Book("919", "ASTROPHYSICS FOR PEOPLE IN A HURRY", "Neil deGrasse Tyson", 2010, 6, "fiction",
            "covers/astro.png", "books/astro.epub"),
        new Book("91009", "THE PSYCHOLOGY OF MONEY", "Morgan Housel", 2019, 3, "non-fiction",
            "covers/money.png", "books/money.epub"),
        new Book("889996", "THE ROAD TO REACT", "Robin Wieruch", 2018, 3, "non-fiction",
            "covers/react.png", "books/react.pdf")
    );
